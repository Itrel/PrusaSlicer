...
Plater::priv::priv(Plater* q, MainFrame* main_frame)
    ...
    , config(Slic3r::DynamicPrintConfig::new_from_defaults_keys({
        ...
        "brim_clip", "brim_width", "brim_separation", "brim_type", "variable_layer_height", "nozzle_diameter", "single_extruder_multi_material",
        ...
        "perimeters", "perimeter_extruder", "fill_density", "infill_extruder", "top_solid_layers",
